...
public:
	...
	bool areOrdered(int node1, int node2) const {
		const VectorClockWithChain& vc1 = m_data.find(node1)->second;
		const VectorClockWithChain& vc2 = m_data.find(node2)->second;
		return vc1.getComponent(vc1.getChain()) <= vc2.getComponent(vc1.getChain());
	}
...
bool VCRaceDetector::areEventActionsOrdered(int eventAction1, int eventAction2) const {
	return m_state->areOrdered(eventAction1, eventAction2);
}

// BOOST_PYTHON_MODULE(srl)
// {
// 	using namespace boost::python;
//     class_<VCRaceDetector>("VCRaceDetector")
//         .def("beginEventAction", &VCRaceDetector::beginEventAction)
//         .def("endEventAction", &VCRaceDetector::endEventAction)
//         .def("denoteCurrentEventAfter", &VCRaceDetector::denoteCurrentEventAfter)
//         .def("areEventActionsOrdered", &VCRaceDetector::areEventActionsOrdered)
//         .def("currentEventAction", &VCRaceDetector::currentEventAction)
//     ;
// }
